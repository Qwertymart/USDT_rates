...
- Получение курса с биржи Grinex должно происходить с помощью HTTP запроса к 
[API биржи](https://garantexio.github.io/#market-data) 
Необходимо использовать https://grinex.io в качестве базового URL, вместо указанного в документации https://garantex.org 
Необходимо использовать метод `GET https://grinex.io/api/v2/depth` (берем первые ask и bid цены из ответа)
